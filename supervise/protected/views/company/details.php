...
<fieldset class="public-wraper" style="height: 800px;">
	...
	<span style="font-family:'Arial Normal', 'Arial';font-weight:400;">推荐提成</span>
		...
		<span><a class="btn-5" style="display: inline-block;" href="<?php echo $this ->createUrl('company/view', array('id'=>$info['id'],'type'=>'推荐奖金','condition'=>$condition));?>">返回</a></span>
...
function getData(page,data){  
    ...
    $.ajax({
        type: 'POST', 
        url: '/supervise/company/RecommPage', 
