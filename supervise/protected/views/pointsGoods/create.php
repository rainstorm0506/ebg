<?php
	...
	Views::js(array('jquery-dragPlug','points.create'));
	...
	<?php $active = $this->beginWidget('CActiveForm', array('id'=>'formWrap','enableAjaxValidation'=>true)); ?>
		<ul>
            ...
            <li>
                <h6><i>*</i>兑换积分：</h6>
                <?php
                $form->points = isset($form->points)&&$form->points!='' ? (double)$form->points : '';
                echo $active->textField($form , 'points' , array('class'=>'tbox34 int-price' , 'style'=>'width:137px;margin:0 5px 0 0'));
                #echo $active->error($form , 'points');
                ?>
            </li>
		...
		<ul>
            ...
            <li>
                ...
                <?php
                    $form->shelf_id = isset($form->shelf_id) ? (int)$form->shelf_id :1102;
            ...
            <li>
                <h6><i>*</i>兑换对象：</h6>
                <span><input type="checkbox" style="margin-top: 12px;" name="PointsGoodsForm[person]" value="1"/>&nbsp;个人&nbsp;&nbsp;</span>
                <span><input type="checkbox" style="margin-top: 12px;" name="PointsGoodsForm[merchant]" value="1"/>&nbsp;商家&nbsp;&nbsp;</span>
                <span><input type="checkbox" style="margin-top: 12px;" name="PointsGoodsForm[company]" value="1"/>&nbsp;企业</span>
            </li>
            <li>
                <h6><i>*</i>备注：</h6>
                <textarea style="width:80%;height:100px;margin:10px 0" name="PointsGoodsForm[remark]"></textarea>
            </li>
			<li>
				<h6>&nbsp;</h6>
	...
	.on('uploadSuccess' , function(file , json)
	{
		...
		uploader.makeThumb(file, function(error , ret)
		{
			if (error)
			{
				...
				if (isSupportBase64)
				{
					$('#goods_cover').val(json.src);
					code += '<img src="'+ret+'"><a class="preview-close">x</a>';
					code += setMinPic ? '<div class="preview-set"><span></span><a>主图</a></div>' : '';
					container.prepend(code);
