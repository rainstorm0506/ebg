...
<div class="navigation">
	...
	<span>
		<form method="get" action="<?php echo $this->createUrl('list'); ?>">
			...
			?>
			<input type="text" name="keyword" class="search-keyword" placeholder="支持搜索商品名称、商家名、商品ID、商品货号" style="width:320px;margin:0 8px 0 0;" value="<?php echo empty($_GET['keyword'])?'':$_GET['keyword']; ?>">
	...
	<ul>
		...
		<li><?php echo CHtml::link('复制全新商品' , $this->createUrl('list') , Views::linkClass('actGoods' , 'copy')); ?></li>
	</ul>
	<i class="clear"></i>
</div>