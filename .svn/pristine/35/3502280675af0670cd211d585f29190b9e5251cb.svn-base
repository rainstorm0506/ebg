	...
	<section class="order-wraper">
		...
		<table class="tab-list-1 mb30px">
			...
			<tbody>
				...
				<tr>
					<td colspan='2'>订单状态：   <span class="pay-status-green">备货完成</span></td>
				</tr>
				<tr>
					<td><h6>物流名称：</h6></td> 
					<td>
				...
				<tr>
					<td style="width:98px;">快递单号：</td> <td><input type="hidden" name='order_sn' value="<?php echo $order_sn;?>"/><input type='text' name='express_no' class='send_goods' id="sendnum" value="<?php echo $express_no;?>"/></td>
				</tr>
				<tr>
					<td>快递发送时间：</td> 
					<td>
