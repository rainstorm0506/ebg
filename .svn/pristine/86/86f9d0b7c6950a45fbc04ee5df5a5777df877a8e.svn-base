...
class CartController extends WebApiController
{
	...
	private function _cartJoin($select = true)
	{
		...
		$pars = array(
			...
			'type'					=> $type,
			'gid'					=> $gid,
			'attrs_1_unite_code'	=> (string)$this->getPost('attrs_1_unite_code'),
			'attrs_2_unite_code'	=> (string)$this->getPost('attrs_2_unite_code'),
			'attrs_3_unite_code'	=> (string)$this->getPost('attrs_3_unite_code'),
		);
