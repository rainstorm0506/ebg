...
?>
	...
	<section class="pop-wrap pop-wrap-2" style="height:300px;display: none" >
		...
		<fieldset class="form-list form-change-tel" id="formBoxs">
			<legend>更换手机号</legend>
			<?php $active = $this->beginWidget('CActiveForm',array('action'=>$this->createUrl('myStore/editPhone',array('s'=>'member')))); ?>
