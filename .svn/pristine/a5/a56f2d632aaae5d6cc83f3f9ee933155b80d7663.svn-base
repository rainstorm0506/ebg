			...
			<fieldset class="form-list crbox18-group set-password-form">
				...
				<?php $active = $this->beginWidget('CActiveForm',array('id'=>'formBox')); ?>
					...
					<ul>
						...
						<li>
							<h6>请填写手机校验码：</h6><input type="hidden" name="type" value="venterprise"/>
							<?php echo $active->textField($form,'codeNum',array('id'=>'codeNum','class'=>'tbox38 tbox38-2','placeholder'=>'短信验证码'));?>
