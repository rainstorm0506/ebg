<?php
class MerSignForm extends ApiForm
{
	public $phone , $password , $vcode , $protocol , $apt , $outTime , $sessKey;
	
	//基本验证
	public function rules()
	{
		return array(
			array('phone,password,vcode,protocol,apt', 'required'),
			array('apt', 'numerical' , 'integerOnly'=>true),
			array('protocol', 'numerical' , 'integerOnly'=>true , 'min'=>0 , 'max'=>1),
