		...
		<fieldset class="form-list">
			...
			<?php $active = $this->beginWidget('CActiveForm',array('id'=>'comanyRegister')); ?>
				<ul>
					...
					<li>
						<h6>营业执照：</h6>
						<div id="com_license" class="_web_uploader" name="SignForm[com_license]"></div>
					...
					<li>
						<h6>税务登记证：</h6>
						<div id="com_tax" class="_web_uploader" name="SignForm[com_tax]"></div>
						<article class="license-txt-list">
							<p>1、请上传公司营业执照复印件照片并盖公司公章；</p>
							<p>2、证件信息清晰可见，且不能被遮挡；</p>
							<p>3、仅支持JPG格式，图片大小不超过5M；</p>
					...
					<li>
						<h6>组织机构代码：</h6>
						<div id="com_org" class="_web_uploader" name="SignForm[com_org]"></div>
						<article class="license-txt-list">
							<p>1、请上传公司营业执照复印件照片并盖公司公章；</p>
							<p>2、证件信息清晰可见，且不能被遮挡；</p>
							<p>3、仅支持JPG格式，图片大小不超过5M；</p>
