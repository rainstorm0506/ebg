...
class CCodeForm extends CActiveForm
{
	...
	{
		echo '<div class="form gii"><p class="note">'
				. Yii::t('gii' , 'Fields with <span class="required">*</span> are required.')
				. Yii::t('gii' , 'Click on the <span class="sticky">highlighted fields</span> to edit them.')
				. '</p>';
		parent::init();
	}
