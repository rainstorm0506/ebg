<h1><?php echo Yii::t('gii', 'Controller Generator'); ?></h1>

<p><?php echo Yii::t('gii', 'This generator helps you to quickly generate a new controller class , one or several controller actions and their corresponding views.'); ?></p>
...
<?php $form=$this->beginWidget('CCodeForm', array('model'=>$model)); ?>
	...
	<div class="row">
		...
		<div class="tooltip">
			<?php echo Yii::t('gii' , 'Controller ID is case-sensitive. Below are some examples:'); ?>
			<ul>
	...
	<div class="row sticky">
		...
		<div class="tooltip">
			<?php echo Yii::t('gii' , 'This is the class that the new controller class will extend from.'); ?>
			<?php echo Yii::t('gii' , 'Please make sure the class exists and can be autoloaded.'); ?>
		</div>
