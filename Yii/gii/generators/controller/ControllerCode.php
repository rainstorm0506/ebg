...
class ControllerCode extends CCodeModel
{
	...
	public function attributeLabels()
	{
		return array_merge(parent::attributeLabels(), array(
			'baseClass'=>Yii::t('gii', 'Base Class'),
			'controller'=>Yii::t('gii', 'Controller ID'),
			'actions'=>Yii::t('gii' , 'Action IDs'),
		));
	}
	...
	{
		$link=CHtml::link(Yii::t('gii' , 'try it now'), Yii::app()->createUrl($this->controller), array('target'=>'_blank'));
		return Yii::t('gii', "The controller has been generated successfully. You may {link}." , array('link'=>$link));
	}
