...
class GlobalGoodsTag
{
	...
	public static function displayTag($tagId = 0 , $icon = false)
	{
		if (self::isDisplay($tagId))
		{
			switch ($tagId)
			{
				case 1 : return $icon ? '<span class="cmark-1"><b></b><q></q><i>爆款</i></span>' : '<span class="pmark-1"><em>爆款</em></span>';
				case 2 : return $icon ? '<span class="cmark"><b></b><q></q><i>就比京东少一元</i></span>' : '<span class="pmark-2"><em>就比京东<br>少一元</em></span>';
			}
		}
		return '';
	}
