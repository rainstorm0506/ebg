<?php
class UsedGoodsForm extends WebForm
{
	public $id , $title ,  $goods_num , $brand_id , $lightspot , $dict_one_id , $dict_two_id , $dict_three_id , $imgsSet , $tag_id;
	...
	{
		$rules = array(
			array('title , tag_id , use_time, cover, content'  , 'required', 'message'=>'<b>{attribute}</b> 是必填或必选项'),
			...
			array('img , shelf , buy_price , lightspot , buy_price , dict_one_id , dict_two_id , dict_three_id , class_one_id , class_two_id , class_three_id',  'checkNull'),
		);
