	...
	<section class="box-wrap">
		...
		$active = $this->beginWidget('CActiveForm',
			array(	
				...
				'htmlOptions'=>array('class'=>'form-wraper','style'=>'height:40px;')		
			)
		); 
		?>
			<span>提交时间：</span>
			...
			?>
			<?php 
			echo CHtml::Button('搜索',array('class'=>'btn-1 btn-1-7','id'=>'check','style'=>'display:inline'));
			?>
