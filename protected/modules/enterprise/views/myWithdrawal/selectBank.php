...
.errorMessage{color:red}
	...
	<nav class="current-stie">
		...
		<span><?php echo CHtml::link('企业中心' , $this->createFrontUrl('enterprise/order'));?></span><i>&gt;</i>
		<span><?php echo CHtml::link('提现记录' , $this->createFrontUrl('enterprise/myWithdrawal'));?></span><i>&gt;</i>
		<span>我要提现</span>
	</nav>
	<!-- main -->
			...
			<?php $active = $this->beginWidget('CActiveForm',array('id'=>'formBox','enableAjaxValidation'=>true)); ?>
				<ul>
					...
					<li>
						<h6>提现金额：</h6>
						<?php
							echo $active->textField($form , 'amount' , array('id'=>'amount','placeholder'=>"请填提现金额",'onclick'=>'$("#account").attr("class","tbox38 tbox38-1")','onfocus'=>'$("#account").attr("class","tbox38 tbox38-1")','class'=>'tbox38 tbox38-1'));
