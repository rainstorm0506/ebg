...
<nav class="current-stie">
	...
	<i>&gt;</i><span><?php echo CHtml::link(GlobalGoodsClass::getClassName($cid),$this->createUrl('class/list',array('id'=>$cid))); ?></span>
	<?php endforeach; ?>
	<i>&gt;</i><span><?php echo GlobalGoodsClass::getClassName($id); ?></span>
	<?php
		if ($brandID)
